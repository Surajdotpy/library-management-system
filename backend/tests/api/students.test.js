...
import { ensureTestAdminPassword, ensureTestUser, syncTableIdSequence, } from '../helpers/test-db.js';
...
describe('Students API', () => {
    ...
    describe('GET /api/students', () => {
        it('should scope branch admins to their assigned branch', async () => {
            ...
            expect(response.body.data.every((student) => student.branch_id === 1)).toBe(true);
        });
    });
});
